...
function GymAccess() {
  ...
  return (
    <div className="uk-width-1-1 uk-margin-medium-top uk-flex uk-flex-row uk-height-medium uk-margin-small-bottom uk-border-rounded" style={{"height": "240px"}}>

        <div className="uk-card uk-height-1-1 uk-border-rounded" style={{"paddingLeft": "5px", "paddingRight": "5px", "width": "22%", "marginRight": "2px"}}>
