...
function ActiveDiv({theprops}: any) {
  ...
  return (
    <div className="alignmentClass uk-card" id="activediv">
        ...
        <div className="uk-card" style={{"width":"30%", "height":"100%", "border": "2px red solid"}}>
            <img src={theprops.actpic1} alt="Holograms" style={{"width":"100%", "height":"100%"}}/>
        </div>
        <div className="uk-card" style={{"width":"40%", "height":"100%", "border": "2px red solid", "display": "flex", "flexDirection":"column"}} id="activeTitle">
